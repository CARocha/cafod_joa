...
class UsoSemilla(models.Model):
    ...
    semillas_conseguidas = models.FloatField('4.5.2-Porcentaje de semillas conseguidas en la comunidad')
    compradas_agroservicio = models.FloatField('4.5.2-Compradas en un agroservicio')
