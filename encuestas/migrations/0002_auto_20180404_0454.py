    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('encuestador', models.ForeignKey(to='encuestas.Encuestadores')),
            ],
            options={
        ...
        migrations.AlterField(
            ...
            name='comunidad',
            field=smart_selects.db_fields.ChainedForeignKey(chained_model_field=b'municipio', chained_field=b'municipio', verbose_name=b'Provincia', blank=True, auto_choose=True, to='lugar.Comunidad', null=True),
        ),
        migrations.AlterField(
            model_name='entrevistados',
            name='microcuenca',
            field=smart_selects.db_fields.ChainedForeignKey(chained_model_field=b'comunidad', chained_field=b'comunidad', verbose_name=b'Comunidad/Cant\xc3\xb3n', blank=True, auto_choose=True, to='lugar.Microcuenca', null=True),
        ),
        migrations.AddField(
